...
class ControllerExtensionShippingCorreios extends Controller {
	...
	public function index() {   
		...
		$data['text_sedex_12'] = $this->language->get('text_sedex_12');
		$data['text_pac_grandes_formatos'] = $this->language->get('text_pac_grandes_formatos');
		$data['text_pac_cobrar'] = $this->language->get('text_pac_cobrar');
		...
		$data['breadcrumbs'] = array();
   		...
   		$data['breadcrumbs'][] = array(
			...
			'href' => $this->url->link('extension/shipping/correios', 'token=' . $this->session->data['token'], 'SSL')
   		);
		
   		$data['action'] = $this->url->link('extension/shipping/correios', 'token=' . $this->session->data['token'], 'SSL');
		...
		if (isset($this->request->post['correios_total_41106'])) {
			$data['correios_total_41106'] = $this->request->post['correios_total_41106'];
		} else {
			$data['correios_total_41106'] = $this->config->get('correios_total_41106');
		}		
		...
		if (isset($this->request->post['correios_total_40010'])) {
			$data['correios_total_40010'] = $this->request->post['correios_total_40010'];
		} else {
			$data['correios_total_40010'] = $this->config->get('correios_total_40010');
		}
		...
		if (isset($this->request->post['correios_total_40045'])) {
			$data['correios_total_40045'] = $this->request->post['correios_total_40045'];
		} else {
			$data['correios_total_40045'] = $this->config->get('correios_total_40045');
		}		
		...
		if (isset($this->request->post['correios_total_40215'])) {
			$data['correios_total_40215'] = $this->request->post['correios_total_40215'];
		} else {
			$data['correios_total_40215'] = $this->config->get('correios_total_40215');
		}		
		...
		if (isset($this->request->post['correios_total_81019'])) {
			$data['correios_total_81019'] = $this->request->post['correios_total_81019'];
		} else {
			$data['correios_total_81019'] = $this->config->get('correios_total_81019');
		}		
		...
		if (isset($this->request->post['correios_total_40126'])) {
			$data['correios_total_40126'] = $this->request->post['correios_total_40126'];
		} else {
			$data['correios_total_40126'] = $this->config->get('correios_total_40126');
		}				
		...
		if (isset($this->request->post['correios_total_40290'])) {
			$data['correios_total_40290'] = $this->request->post['correios_total_40290'];
		} else {
			$data['correios_total_40290'] = $this->config->get('correios_total_40290');
		}		
		...
		if (isset($this->request->post['correios_total_40096'])) {
			$data['correios_total_40096'] = $this->request->post['correios_total_40096'];
		} else {
			$data['correios_total_40096'] = $this->config->get('correios_total_40096');
		}		
		...
		if (isset($this->request->post['correios_total_40436'])) {
			$data['correios_total_40436'] = $this->request->post['correios_total_40436'];
		} else {
			$data['correios_total_40436'] = $this->config->get('correios_total_40436');
		}		
		...
		if (isset($this->request->post['correios_total_40444'])) {
			$data['correios_total_40444'] = $this->request->post['correios_total_40444'];
		} else {
			$data['correios_total_40444'] = $this->config->get('correios_total_40444');
		}		
		...
		if (isset($this->request->post['correios_total_40568'])) {
			$data['correios_total_40568'] = $this->request->post['correios_total_40568'];
		} else {
			$data['correios_total_40568'] = $this->config->get('correios_total_40568');
		}		
		...
		if (isset($this->request->post['correios_total_40606'])) {
			$data['correios_total_40606'] = $this->request->post['correios_total_40606'];
		} else {
			$data['correios_total_40606'] = $this->config->get('correios_total_40606');
		}		
		...
		if (isset($this->request->post['correios_total_41068'])) {
			$data['correios_total_41068'] = $this->request->post['correios_total_41068'];
		} else {
			$data['correios_total_41068'] = $this->config->get('correios_total_41068');
		}		
		...
		if (isset($this->request->post['correios_total_81027'])) {
			$data['correios_total_81027'] = $this->request->post['correios_total_81027'];
		} else {
			$data['correios_total_81027'] = $this->config->get('correios_total_81027');
		}		
		...
		if (isset($this->request->post['correios_total_81035'])) {
			$data['correios_total_81035'] = $this->request->post['correios_total_81035'];
		} else {
			$data['correios_total_81035'] = $this->config->get('correios_total_81035');
		}		
		...
		if (isset($this->request->post['correios_total_81868'])) {
			$data['correios_total_81868'] = $this->request->post['correios_total_81868'];
		} else {
			$data['correios_total_81868'] = $this->config->get('correios_total_81868');
		}		
		...
		if (isset($this->request->post['correios_total_81833'])) {
			$data['correios_total_81833'] = $this->request->post['correios_total_81833'];
		} else {
			$data['correios_total_81833'] = $this->config->get('correios_total_81833');
		}		
		...
		if (isset($this->request->post['correios_total_81850'])) {
			$data['correios_total_81850'] = $this->request->post['correios_total_81850'];
		} else {
			$data['correios_total_81850'] = $this->config->get('correios_total_81850');
		}		
		
		// PAC Grandes Formatos
		if (isset($this->request->post['correios_41300'])) {
			$data['correios_41300'] = $this->request->post['correios_41300'];
		} else {
			$data['correios_41300'] = $this->config->get('correios_41300');
		}
		
		if (isset($this->request->post['correios_total_41300'])) {
			$data['correios_total_41300'] = $this->request->post['correios_total_41300'];
		} else {
			$data['correios_total_41300'] = $this->config->get('correios_total_41300');
		}		

		// PAC a Cobrar
		if (isset($this->request->post['correios_41262'])) {
			$data['correios_41262'] = $this->request->post['correios_41262'];
		} else {
			$data['correios_41262'] = $this->config->get('correios_41262');
		}
		
		if (isset($this->request->post['correios_total_41262'])) {
			$data['correios_total_41262'] = $this->request->post['correios_total_41262'];
		} else {
			$data['correios_total_41262'] = $this->config->get('correios_total_41262');
		}		

		// Sedex 12
		if (isset($this->request->post['correios_40169'])) {
			$data['correios_40169'] = $this->request->post['correios_40169'];
		} else {
			$data['correios_40169'] = $this->config->get('correios_40169');
		}
		
		if (isset($this->request->post['correios_total_40169'])) {
			$data['correios_total_40169'] = $this->request->post['correios_total_40169'];
		} else {
			$data['correios_total_40169'] = $this->config->get('correios_total_40169');
		}				
